    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/modules" className="bg-white text-green-700 hover:bg-green-100 px-6 py-3 rounded-md font-medium transition-colors flex items-center justify-center">
                <BookOpen size={18} className="mr-2" /> Découvrir le programme
              </Link>
              <Link to="/certification" className="bg-transparent border-2 border-white hover:bg-white hover:text-green-700 px-6 py-3 rounded-md font-medium transition-colors flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-green-50 p-6 rounded-lg shadow-md transition-transform hover:scale-105">
              <h3 className="text-xl font-bold mb-4 text-green-800">Titre Professionnel</h3>
              <p>Développeur web et web mobile - Niveau 5 (Cadre national des certifications 2019)</p>
              <p className="mt-2 text-green-600">Code NSF : 326t - Programmation, mise en place</p>
            </div>

            <div className="bg-green-50 p-6 rounded-lg shadow-md transition-transform hover:scale-105">
              <h3 className="text-xl font-bold mb-4 text-green-800">Période de Stage</h3>
              <div className="flex items-center mb-2">
                <CalendarClock size={20} className="text-green-600 mr-2" />
            ...
            <div className="bg-green-50 p-6 rounded-lg shadow-md transition-transform hover:scale-105">
              <h3 className="text-xl font-bold mb-4 text-green-800">Projet Final</h3>
              <p>À la fin de la formation, vous présenterez un projet (niveau BAC+2) démontrant vos compétences en développement web.</p>
              <p className="mt-2 text-green-600">Application responsive fonctionnant sur tous les navigateurs</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* PHP & Symphony */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-24 bg-gradient-to-r from-green-400 to-indigo-500 flex items-center justify-center">
          ...
          <div className="text-center mt-10">
            <Link to="/modules" className="bg-green-700 text-white px-6 py-3 rounded-md font-medium hover:bg-green-800 transition-colors inline-flex items-center">
      ...
      <section className="py-16 bg-green-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/contact" className="bg-white text-green-900 hover:bg-green-100 px-8 py-3 rounded-md font-medium transition-colors inline-block">
            Contactez-nous
          </Link>
        </div>
      </section>
