      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg mb-12">
          <div className="flex">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-green-800">Titre Professionnel : Développeur web et web mobile</p>
              <p className="mt-1 text-sm text-green-600">Sigle du titre professionnel : DWWM</p>
              <p className="mt-1 text-sm text-green-600">Niveau : 5 (Cadre national des certifications 2019)</p>
              <p className="mt-1 text-sm text-green-600">Code(s) NSF : 326t - Programmation, mise en place</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6 md:p-8">
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-8 md:left-1/2 h-full w-0.5 bg-green-200 transform -translate-x-1/2"></div>
              ...
              <div className="space-y-12">
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 md:pr-8 md:text-right mb-4 md:mb-0">
                      <div className="bg-green-50 p-4 rounded-lg shadow-sm inline-block">
                        <h3 className="font-semibold text-green-800">Formation théorique et pratique</h3>
                        <p className="text-gray-600">Apprentissage des modules et réalisation de projets pratiques</p>
                      </div>
                    </div>
                    <div className="z-10 flex items-center justify-center w-16 h-16 bg-white rounded-full border-4 border-green-400">
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="z-10 flex items-center justify-center w-16 h-16 bg-white rounded-full border-4 border-green-400 order-2">
                      <Calendar className="h-8 w-8 text-green-500" />
                    </div>
                    <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0 order-3">
                      <div className="bg-green-50 p-4 rounded-lg shadow-sm inline-block">
                        <h3 className="font-semibold text-green-800">Stage en entreprise</h3>
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 md:pr-8 md:text-right mb-4 md:mb-0">
                      <div className="bg-green-50 p-4 rounded-lg shadow-sm inline-block">
                        <h3 className="font-semibold text-green-800">Préparation du projet final</h3>
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0 order-3">
                      <div className="bg-green-50 p-4 rounded-lg shadow-sm inline-block">
                        <h3 className="font-semibold text-green-800">Présentation du projet & Certification</h3>
